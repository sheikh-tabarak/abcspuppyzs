...
function loadCards() {
    for (let index = 0; index < Litters.length; index++) {
        if (Litters[index].mode === 0) {
            document.getElementById('litter-container').innerHTML += '<div class="shadow m-8 py-10 w-full max-w-screen-xl mx-auto border-[1px] rounded flex flex-wrap justify-center items-center  lg:divide-y-0 lg:divide-x-2"> <div class="w-[100%] md:w-[100%] lg:w-[70%] lg:px-10"> <div class="text-2xl font-extrabold px-10 lg:px-0 text-center lg:text-left ">' + Litters[index].name + '</div>  <table class="py-4 w-full mt-2"> <thead> </thead><tbody class="">  <tr class="even:bg-white odd:bg-gray-50  border-b border-t "> <th scope="row" class="px-4 py-2 w-[35%] font-bold text-gray-900 text-right "> Litter Type: </th> <td class="px-4 py-2 text-left">' + Litters[index].type + ' </td> </tr> <tr class="even:bg-white odd:bg-gray-50  border-b "> <th scope="row" class="px-4 py-2 font-bold text-gray-900 text-right "> Average Weight: </th> <td class="px-4 py-2 text-left"> ' + Litters[index].avg_weight + ' </td> </tr> <tr class="even:bg-white odd:bg-gray-50  border-b "> <th scope="row" class="px-4 py-2 font-bold text-gray-900  text-right"> Litter Status: </th> <td class="px-4 py-2 text-left"> ' + Litters[index].status.text + '</td> </tr>         <tr id="expected-or-born' + index + '" class="even:bg-white odd:bg-gray-50  border-b "> </tr>      <tr id="age-' + index + '" class="even:bg-white odd:bg-gray-50  border-b "> </tr>             <tr id="go-home-row' + index + '" class="even:bg-white odd:bg-gray-50  border-b ">   </tr></tbody><tbody id="prices-container' + index + '"></tbody>  </table>  <div class="px-4 pb-4 flex justify-center lg:pr-40" id="thumbnail-container-' + index + '"></div> </div> <div class="w-[100%] lg:w-[30%] px-5"> <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-300"> <li class="py-3 sm:py-4"> <div class="flex flex-wrap justify-center lg:justify-start items-center"> <div class="relative"> <div onclick="showMainPopup(' + index + ')" class="absolute flex justify-center items-center right-10 top-10 cursor-pointer"> <div class=" absolute w-10 h-10 bg-white  rounded-full animate-ping"> </div> <div class="absolute"><svg class="hover:scale-[1.1] transition duration-1000" width="40px" height="40px" viewBox="0 0 24 24" fill="gray" xmlns="http://www.w3.org/2000/svg"> <rect width="24" height="24" fill="none" /> <path fill-rule="evenodd" clip-rule="evenodd" d="M7 12C7 11.4477 7.44772 11 8 11H8.01C8.56228 11 9.01 11.4477 9.01 12C9.01 12.5523 8.56228 13 8.01 13H8C7.44772 13 7 12.5523 7 12ZM11 12C11 11.4477 11.4477 11 12 11H12.01C12.5623 11 13.01 11.4477 13.01 12C13.01 12.5523 12.5623 13 12.01 13H12C11.4477 13 11 12.5523 11 12ZM16 11C15.4477 11 15 11.4477 15 12C15 12.5523 15.4477 13 16 13H16.01C16.5623 13 17.01 12.5523 17.01 12C17.01 11.4477 16.5623 11 16.01 11H16ZM2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12Z" fill="white" /> </svg> </div> </div> <img class="w-96 rounded-lg" src="' + Litters[index].image + '" alt="Neil image"> </div> </li> </ul> </div> </div>';
            ...
            document.getElementById('litter-container').innerHTML += '<div class="shadow m-8 py-10 w-full max-w-screen-xl mx-auto border-[1px] rounded flex flex-wrap justify-center divide-y-2 lg:divide-y-0 lg:divide-x-2"> <div class="w-[100%] md:w-[100%] lg:w-[55%] lg:px-10"> <div class="text-2xl font-extrabold px-10 lg:px-0 text-center lg:text-left ">' + Litters[index].name + '</div>  <table class=" my-4 w-full"> <thead> </thead> <tbody class=""> <tr class="even:bg-white odd:bg-gray-50  border-b border-t "> <th scope="row" class="w-[35%] px-4 py-2 font-bold text-gray-900  text-right"> Litter Type: </th> <td class="px-4 py-2 text-left">' + Litters[index].type + ' </td> </tr> <tr class="even:bg-white odd:bg-gray-50  border-b border-t"> <th scope="row" class="px-4 py-2 font-bold text-gray-900  text-right"> Average Weight: </th> <td class="px-4 py-2 text-left"> ' + Litters[index].avg_weight + ' </td> </tr> <tr class="even:bg-white odd:bg-gray-50  border-b "> <th scope="row" class="px-4 py-2 font-bold text-gray-900  text-right"> Litter Status: </th> <td class="px-4 py-2 text-left"> ' + Litters[index].status.text + '</td> </tr>  <tr id="go-home-row' + index + '" class="even:bg-white odd:bg-gray-50  border-b ">   </tr><tr id="age-' + index + '" class="even:bg-white odd:bg-gray-50  border-b ">   </tr></tbody><tbody id="prices-container' + index + '"></tbody>  </table> <div class="px-4 pb-4 flex justify-center lg:pr-40" id="thumbnail-container' + index + '"></div> </div> <div class="w-[100%] lg:w-[45%] "><div class="text-2xl font-extrabold px-10  py-5 text-left "> All Puppies </div> <ul id="multiple-litters' + index + '" class="divide-y divide-gray-200 "></ul> </div> </div>'
